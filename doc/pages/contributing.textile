...
Came to Buildr as a refuge from the Maven Uncertainly Principle.  Alex has been working mostly on the Scala integration and believes Ruby scripting is a great complement to statically typed languages. 
